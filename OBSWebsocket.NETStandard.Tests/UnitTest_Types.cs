...
namespace OBSWebsocket.NETStandard.Tests
{
    [TestClass]
    public class UnitTest_Types
    {
        ...
        {
            string sceneName = "Scene name הכפû";
            string itemName = "First item name הכפû";
        ...
        {
            string name = "Source name יטüןצמפ";
        ...
        {
            string transitionName = "Transition name יטןצü";
            int duration = 2000;
